...
function buildSlashCommands() {
    return [
        ...
        new SlashCommandBuilder()
            ...
            .setDefaultMemberPermissions(PermissionFlagsBits.Administrator)
            .addSubcommand((s) => s.setName('statut').setDescription('État vitrine, sauvegarde, salon public'))
            .addSubcommand((s) =>
                s.setName('sauvegarder').setDescription('Sauver les permissions @everyone (à faire avant activer)')
            )
            .addSubcommand((s) =>
                s
                    .setName('salon_public')
                    .setDescription('Salon restant visible pour @everyone pendant la vitrine')
                    .addChannelOption((o) =>
                        o.setName('salon').setDescription('Texte ou annonces').setRequired(true)
                    )
            )
            .addSubcommand((s) =>
                s.setName('activer').setDescription('Masquer les autres salons pour @everyone')
            )
            .addSubcommand((s) =>
                s
                    .setName('restaurer')
