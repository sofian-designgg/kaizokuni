...
function buildSlashCommands() {
    return [
        ...
        new SlashCommandBuilder()
            .setName('importjson')
            .setDescription('Importer un export JSON et republier dans un salon (admin)')
            .setDefaultMemberPermissions(PermissionFlagsBits.Administrator)
            .addAttachmentOption((o) =>
                o
                    .setName('fichier')
                    .setDescription('Le fichier .json exporté')
                    .setRequired(true)
            )
            .addChannelOption((o) =>
                o
            ...
            .addIntegerOption((o) =>
                o
                    .setName('limit')
                    .setDescription('Nombre de messages max (1-500)')
                    .setMinValue(1)
                    .setMaxValue(500)
            )
            .addBooleanOption((o) =>
                o
                    .setName('pieces_jointes')
                    .setDescription('Importer aussi les fichiers (défaut: oui)')
            ),
